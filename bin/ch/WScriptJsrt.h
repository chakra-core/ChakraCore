...
public:
    ...
    static JsValueRef CALLBACK EchoCallback(FILE *file, JsValueRef callee, bool isConstructCall, JsValueRef *arguments, unsigned short argumentCount, void *callbackState);
