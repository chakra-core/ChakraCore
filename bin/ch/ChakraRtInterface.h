...
struct JsAPIHooks
{
    ...
    typedef JsErrorCode (WINAPI *JsrtNumberToInt64Ptr)(JsValueRef value, int64_t *intValue);
    ...
    JsrtNumberToInt64Ptr pfJsrtNumberToInt64;
...
#define HOOK_JS_API(x) m_jsApiHooks.pfJsrt##x
    ...
    static JsErrorCode WINAPI JsNumberToInt64(JsValueRef value, int64_t* intValue) { return HOOK_JS_API(NumberToInt64(value, intValue)); }
