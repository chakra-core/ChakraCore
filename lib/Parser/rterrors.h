...
RT_ERROR_MSG(WASMERR_SignatureMismatch, 5680, "%s called with unexpected signature", "Function called with unexpected signature", kjstWebAssemblyRuntimeError, 0)
