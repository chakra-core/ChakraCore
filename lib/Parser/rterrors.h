...
RT_ERROR_MSG(JSERR_ImmutablePrototypeSlot, 5149, "%s: Can't set the prototype slot of this object.", "Can't set the prototype slot of this object.", kjstTypeError, 0)
