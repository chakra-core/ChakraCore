...
template IdentPtr HashTbl::PidHashNameLen<wchar16>(wchar16 const * prgch, ulong cch);
...
template IdentPtr HashTbl::FindExistingPid<wchar16>(
    wchar16 const * prgch, long cch, ulong luHash, IdentPtr **pppInsert, long *pBucketCount
#if PROFILE_DICTIONARY
    , int& depth
#endif
    );
