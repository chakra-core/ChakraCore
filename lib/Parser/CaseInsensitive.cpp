...
*/
        ...
        static const Transform transforms[] =
        {
            ...
            1, MappingSource::UnicodeData, 0x01c4, 0x01c4, 0, 2, 2, 2,
            1, MappingSource::UnicodeData, 0x01c5, 0x01c5, 0, 1, 1, 1,
            1, MappingSource::UnicodeData, 0x01c6, 0x01c6, -2, -1, 0, 0,
            1, MappingSource::UnicodeData, 0x01c7, 0x01c7, 0, 2, 2, 2,
            1, MappingSource::UnicodeData, 0x01c8, 0x01c8, 0, 1, 1, 1,
            1, MappingSource::UnicodeData, 0x01c9, 0x01c9, -2, -1, 0, 0,
            1, MappingSource::UnicodeData, 0x01ca, 0x01ca, 0, 2, 2, 2,
            1, MappingSource::UnicodeData, 0x01cb, 0x01cb, 0, 1, 1, 1,
            ...
            1, MappingSource::UnicodeData, 0x01f1, 0x01f1, 0, 2, 2, 2,
            1, MappingSource::UnicodeData, 0x01f2, 0x01f2, 0, 1, 1, 1,
