...
#define DEFAULT_CONFIG_BytecodeOptimizer  (true)
...
FLAGNR(Boolean, BytecodeOptimizer, "Optimize bytecode size in the bytecode emitter", DEFAULT_CONFIG_BytecodeOptimizer)
