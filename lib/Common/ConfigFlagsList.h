...
PHASE(All, true)
    ...
    PHASE(Module, true)
    PHASE(LibInit, true)
        PHASE(JsLibInit, true)
    PHASE(Parse, true)
        PHASE(RegexCompile, true)
        PHASE(DeferParse, true)
        PHASE(Redeferral, true)
        PHASE(DeferEventHandlers, true)
        PHASE(FunctionSourceInfoParse, true)
        PHASE(StringTemplateParse, true)
        PHASE(SkipNestedDeferred, true)
        PHASE(CacheScopeInfoNames, true)
        PHASE(ScanAhead, false)
        PHASE(ParallelParse, false)
        PHASE(EarlyReferenceErrors, false)
    PHASE(ByteCode, true)
        PHASE(CachedScope, true)
        PHASE(StackFunc, true)
        PHASE(StackClosure, true)
        PHASE(DisableStackFuncOnDeferredEscape, true)
        PHASE(DelayCapture, true)
        PHASE(DebuggerScope, true)
        PHASE(ByteCodeSerialization, true)
            PHASE(VariableIntEncoding, true)
        PHASE(NativeCodeSerialization, true)
        PHASE(OptimizeBlockScope, true)
    PHASE(Delay, true)
        PHASE(Speculation, true)
        PHASE(GatherCodeGenData, true)
    PHASE(Wasm, true)
        // Wasm frontend
        PHASE(WasmBytecode, true)
        PHASE(WasmReader, true)
            PHASE(WasmSection, true)
            PHASE(WasmLEB128, true)
        // Wasm features per functions
        PHASE(WasmDeferred, true)
        PHASE(WasmValidatePrejit, false)
        PHASE(WasmInOut, true) // Trace input and output of wasm calls
        PHASE(WasmMemWrites, true) // Trace memory writes
    PHASE(Asmjs, true)
        PHASE(AsmjsTmpRegisterAllocation, true)
        PHASE(AsmjsEncoder, true)
        PHASE(AsmjsInterpreter, true)
        PHASE(AsmJsJITTemplate, false)
        PHASE(AsmjsFunctionEntry, false)
        PHASE(AsmjsInterpreterStack, true)
        PHASE(AsmjsEntryPointInfo, true)
        PHASE(AsmjsCallDebugBreak, false)
        PHASE(BackEnd, true)
        PHASE(IRBuilder, true)
            PHASE(SwitchOpt, true)
            PHASE(BailOnNoProfile, true)
            PHASE(BackendConcatExprOpt, true)
            PHASE(ClosureRangeCheck, true)
            PHASE(ClosureRegCheck, true)
        PHASE(Inline, true)
            PHASE(InlineRecursive, true)
            PHASE(InlineAtEveryCaller, true)      //Inlines a function, say, foo at every caller of foo. Doesn't guarantee all the calls within foo are inlined too.
            PHASE(InlineTree, true)               //Inlines every function within a top function, say, foo (which needs to be top function) Note: -force:inline achieves the effect of both -force:InlineTree & -force:InlineAtEveryCaller
            PHASE(TryAggressiveInlining, true)
            PHASE(InlineConstructors, true)
            PHASE(InlineBuiltIn, true)
            PHASE(InlineInJitLoopBody, true)
            PHASE(InlineAccessors, true)
            PHASE(InlineGetters, true)
            PHASE(InlineSetters, true)
            PHASE(InlineApply, true)
            PHASE(InlineApplyTarget, true)
            PHASE(InlineApplyWithoutArrayArg, true)
            PHASE(BailOutOnNotStackArgs, true)
            PHASE(InlineCall, true)
            PHASE(InlineCallTarget, true)
            PHASE(PartialPolymorphicInline, true)
            PHASE(PolymorphicInline, true)
            PHASE(PolymorphicInlineFixedMethods, true)
            PHASE(InlineOutsideLoops, true)
            PHASE(InlineFunctionsWithLoops, true)
            PHASE(EliminateArgoutForInlinee, false)
            PHASE(InlineBuiltInCaller, true)
            PHASE(InlineArgsOpt, true)
                PHASE(RemoveInlineFrame, true)
            PHASE(InlinerConstFold, true)
    PHASE(ExecBOIFastPath, true)
        PHASE(FGBuild, true)
            PHASE(OptimizeTryFinally, true)
            PHASE(RemoveBreakBlock, true)
            PHASE(TailDup, true)
        PHASE(FGPeeps, true)
        PHASE(GlobOpt, true)
            PHASE(OptimizeTryCatch, true)
            PHASE(Backward, true)
                PHASE(TrackIntUsage, true)
                PHASE(TrackNegativeZero, true)
                PHASE(TypedArrayVirtual, true)
                PHASE(TrackIntOverflow, true)
                PHASE(TrackCompoundedIntOverflow, true)
            PHASE(Forward, true)
                PHASE(ValueTable, true)
                PHASE(PathDependentValues, true)
                    PHASE(TrackRelativeIntBounds, true)
                        PHASE(BoundCheckElimination, true)
                            PHASE(BoundCheckHoist, true)
                                PHASE(LoopCountBasedBoundCheckHoist, true)
                PHASE(CopyProp, true)
                    PHASE(ObjPtrCopyProp, true)
                PHASE(ConstProp, true)
                PHASE(Int64ConstProp, false)
                PHASE(ConstFold, true)
                PHASE(CSE, true)
                PHASE(HoistConstInt, true)
                PHASE(TypeSpec, true)
                PHASE(AggressiveIntTypeSpec, true)
                PHASE(AggressiveMulIntTypeSpec, true)
                PHASE(LossyIntTypeSpec, true)
                PHASE(FloatTypeSpec, true)
                PHASE(StringTypeSpec, true)
                PHASE(InductionVars, true)
                PHASE(Invariants, true)
                PHASE(FieldCopyProp, true)
                PHASE(FieldHoist, true)
                PHASE(FieldPRE, true)
                PHASE(HostOpt, true)
                PHASE(ObjTypeSpec, true)
                    PHASE(ObjTypeSpecNewObj, true)
                    PHASE(ObjTypeSpecIsolatedFldOps, true)
                    PHASE(ObjTypeSpecIsolatedFldOpsWithBailOut, false)
                    PHASE(ObjTypeSpecStore, true)
                    PHASE(EquivObjTypeSpec, true)
                    PHASE(EquivObjTypeSpecByDefault, true)
                    PHASE(TraceObjTypeSpecTypeGuards, true)
                    PHASE(TraceObjTypeSpecWriteGuards, true)
                    PHASE(LiveOutFields, false)
                    PHASE(DisabledObjTypeSpec, true)
                    #if DBG
                        PHASE(SimulatePolyCacheWithOneTypeForFunction, false)
                    #endif
                PHASE(CheckThis, true)
                PHASE(StackArgOpt, true)
                PHASE(StackArgFormalsOpt, true)
                PHASE(IndirCopyProp, true)
                PHASE(ArrayCheckHoist, true)
                    PHASE(ArrayMissingValueCheckHoist, true)
                    PHASE(ArraySegmentHoist, true)
                        PHASE(JsArraySegmentHoist, true)
                    PHASE(ArrayLengthHoist, true)
                    PHASE(EliminateArrayAccessHelperCall, true)
                PHASE(NativeArray, true)
                    PHASE(NativeNewScArray, true)
                    PHASE(NativeArrayConversion, true)
                    PHASE(CopyOnAccessArray, true)
                    PHASE(NativeArrayLeafSegment, true)
                PHASE(TypedArrayTypeSpec, true)
                PHASE(LdLenIntSpec, true)
                PHASE(FixDataProps, true)
                PHASE(FixMethodProps, true)
                PHASE(FixAccessorProps, true)
                PHASE(FixDataVarProps, false)
                PHASE(UseFixedDataProps, true)
                PHASE(UseFixedDataPropsInInliner, true)
                PHASE(LazyBailout, false)
                    PHASE(LazyFixedDataBailout, true)
                    PHASE(LazyFixedTypeBailout, true)
                PHASE(FixedMethods, true)
                    PHASE(FEFixedMethods, true)
                    PHASE(FixedFieldGuardCheck, true)
                    PHASE(FixedNewObj, true)
                        PHASE(JitAllocNewObj, true)
                    PHASE(FixedCtorInlining, true)
                    PHASE(FixedCtorCalls, true)
                    PHASE(FixedScriptMethodInlining, true)
                    PHASE(FixedScriptMethodCalls, false)
                    PHASE(FixedBuiltInMethodInlining, true)
                    PHASE(FixedBuiltInMethodCalls, true)
                    PHASE(SplitNewScObject, true)
                PHASE(OptTagChecks, true)
                PHASE(MemOp, true)
                    PHASE(MemSet, true)
                    PHASE(MemCopy, true)
                PHASE(IncrementalBailout, true)
            PHASE(DeadStore, true)
                PHASE(ReverseCopyProp, true)
                PHASE(MarkTemp, true)
                    PHASE(MarkTempNumber, true)
                    PHASE(MarkTempObject, true)
                    PHASE(MarkTempNumberOnTempObject, true)
        PHASE(DumpGlobOptInstr, true) // Print the Globopt instr string in post lower dumps
        PHASE(Lowerer, true)
            PHASE(FastPath, true)
                PHASE(LoopFastPath, true)
                PHASE(MathFastPath, true)
                PHASE(Atom, true)
                    PHASE(MulStrengthReduction, true)
                    PHASE(AgenPeeps, true)
                PHASE(BranchFastPath, true)
                PHASE(CallFastPath, true)
                PHASE(BitopsFastPath, true)
                PHASE(OtherFastPath, true)
                PHASE(ObjectFastPath, true)
                PHASE(ProfileBasedFldFastPath, true)
                PHASE(AddFldFastPath, true)
                PHASE(RootObjectFldFastPath, true)
                PHASE(ArrayLiteralFastPath, true)
                PHASE(ArrayCtorFastPath, true)
                PHASE(NewScopeSlotFastPath, true)
                PHASE(FrameDisplayFastPath, true)
                PHASE(HoistMarkTempInit, true)
                PHASE(HoistConstAddr, true)
            PHASE(JitWriteBarrier, true)
            PHASE(PreLowererPeeps, true)
            PHASE(CFGInJit, true)
            PHASE(TypedArray, true)
            PHASE(TracePinnedTypes, true)
        PHASE(InterruptProbe, true)
        PHASE(EncodeConstants, true)
        PHASE(RegAlloc, true)
            PHASE(Liveness, true)
                PHASE(RegParams, false)
            PHASE(LinearScan, true)
                PHASE(OpHelperRegOpt, true)
                PHASE(StackPack, true)
                PHASE(SecondChance, true)
                PHASE(RegionUseCount, true)
                PHASE(RegHoistLoads, true)
                PHASE(ClearRegLoopExit, true)
        PHASE(Peeps, true)
        PHASE(Layout, true)
        PHASE(EHBailoutPatchUp, true)
        PHASE(FinalLower, true)
        PHASE(PrologEpilog, true)
        PHASE(InsertNOPs, true)
        PHASE(Encoder, true)
            PHASE(Emitter, true)
            PHASE(DebugBreak, false)
#if defined(_M_IX86) || defined(_M_X64)
            PHASE(BrShorten, true)
                PHASE(LoopAlign, true)
#endif
...
#endif
    PHASE(Run, true)
        PHASE(Interpreter, true)
        PHASE(EvalCompile, true)
            PHASE(FastIndirectEval, true)
        PHASE(IdleDecommit, true)
        PHASE(IdleCollect, true)
        PHASE(MemoryAllocation, true)
#ifdef RECYCLER_PAGE_HEAP
            PHASE(PageHeap, true)
#endif
            PHASE(LargeMemoryAllocation, true)
            PHASE(PageAllocatorAlloc, true)
        PHASE(Recycler, true)
            PHASE(ThreadCollect, true)
            PHASE(ExplicitFree, true)
            PHASE(ExpirableCollect, true)
            PHASE(GarbageCollect, true)
            PHASE(ConcurrentCollect, true)
                PHASE(BackgroundResetMarks, true)
                PHASE(BackgroundFindRoots, true)
                PHASE(BackgroundRescan, true)
                PHASE(BackgroundRepeatMark, true)
                PHASE(BackgroundFinishMark, true)
            PHASE(ConcurrentPartialCollect, true)
            PHASE(ParallelMark, true)
            PHASE(PartialCollect, true)
                PHASE(ResetMarks, true)
                PHASE(ResetWriteWatch, true)
                PHASE(FindRoot, true)
                    PHASE(FindRootArena, true)
                    PHASE(FindImplicitRoot, true)
                    PHASE(FindRootExt, true)
                PHASE(ScanStack, true)
                PHASE(ConcurrentMark, true)
                PHASE(ConcurrentWait, true)
                PHASE(Rescan, true)
                PHASE(Mark, true)
                PHASE(Sweep, true)
                    PHASE(SweepWeak, true)
                    PHASE(SweepSmall, true)
                    PHASE(SweepLarge, true)
                    PHASE(SweepPartialReuse, true)
                PHASE(ConcurrentSweep, true)
                PHASE(Finalize, true)
                PHASE(Dispose, true)
                PHASE(FinishPartial, true)
        PHASE(Host, true)
        PHASE(BailOut, true)
        PHASE(RegexQc, true)
        PHASE(RegexOptBT, true)
        PHASE(InlineCache, true)
        PHASE(PolymorphicInlineCache, true)
        PHASE(MissingPropertyCache, true)
        PHASE(PropertyStringCache, true)
        PHASE(CloneCacheInCollision, true)
        PHASE(ConstructorCache, true)
        PHASE(InlineCandidate, true)
        PHASE(InlineHostCandidate, true)
        PHASE(ScriptFunctionWithInlineCache, true)
        PHASE(IsConcatSpreadableCache, true)
        PHASE(Arena, true)
        PHASE(ApplyUsage, true)
        PHASE(ObjectHeaderInlining, true)
            PHASE(ObjectHeaderInliningForConstructors, true)
            PHASE(ObjectHeaderInliningForObjectLiterals, true)
            PHASE(ObjectHeaderInliningForEmptyObjects, false)
        PHASE(OptUnknownElementName, true)
#if DBG_DUMP
        PHASE(TypePropertyCache, true)
        PHASE(InlineSlots, true)
#endif
        PHASE(DynamicProfile, true)
#ifdef DYNAMIC_PROFILE_STORAGE
        PHASE(DynamicProfileStorage, true)
#endif
        PHASE(JITLoopBody, true)
        PHASE(JITLoopBodyInTryCatch, true)
        PHASE(ReJIT, true)
        PHASE(ExecutionMode, true)
        PHASE(SimpleJitDynamicProfile, true)
        PHASE(SimpleJit, true)
        PHASE(FullJit, true)
        PHASE(FailNativeCodeInstall, false)
        PHASE(PixelArray, true)
        PHASE(Etw, true)
        PHASE(Profiler, true)
        PHASE(CustomHeap, true)
        PHASE(XDataAllocator, true)
        PHASE(PageAllocator, true)
        PHASE(StringConcat, true)
#if DBG_DUMP
        PHASE(PRNG, true)
#endif
        PHASE(PreReservedHeapAlloc, true)
        PHASE(CFG, true)
        PHASE(ExceptionStackTrace, true)
        PHASE(ExtendedExceptionInfoStackTrace, true)
        PHASE(ProjectionMetadata, true)
        PHASE(TypeHandlerTransition, true)
        PHASE(Debugger, true)
            PHASE(ENC, true)
        PHASE(ConsoleScope, true)
        PHASE(ScriptProfiler, true)
        PHASE(JSON, true)
        PHASE(RegexResultNotUsed, true)
        PHASE(Error, true)
        PHASE(PropertyRecord, true)
        PHASE(TypePathDynamicSize, true)
        PHASE(ConditionalCompilation, true)
        PHASE(InterpreterProfile, true)
        PHASE(InterpreterAutoProfile, true)
        PHASE(ByteCodeConcatExprOpt, true)
        PHASE(TraceInlineCacheInvalidation, true)
        PHASE(TracePropertyGuards, true)
#ifdef ENABLE_JS_ETW
        PHASE(StackFramesEvent, true)
#endif
        PHASE(PerfHint, true)
        PHASE(TypeShareForChangePrototype, true)
        PHASE(DeferSourceLoad, true)
        PHASE(ObjectMutationBreakpoint, true)
        PHASE(NativeCodeData, true)
#undef PHASE
#endif
