...
#define DEFAULT_CONFIG_ES7AsyncEval            (false)
...
FLAGPR_REGOVR_EXP(Boolean, ES6, ES7AsyncEval           , "Enable eval in async functions in non-strict mode"        , DEFAULT_CONFIG_ES7AsyncEval)
