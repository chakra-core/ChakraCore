...
namespace Js
{
    ...
    NUMBER_UTIL_INLINE uint32 NumberUtilities::ToSpecial32(float value)
    {
        return  *(reinterpret_cast<uint32 *>(&value));
    }

    NUMBER_UTIL_INLINE float NumberUtilities::ReinterpretBits32(int value)
    {
    ...
    {
        uint32 nCompare = ToSpecial32(value);
