...
#pragma warning(pop)
    ...
    ***************************************************************************/
    ...
    charcount_t NumberUtilities::UInt16ToString(uint16 integer, _Out_ __ecount(outBufferSize) WCHAR* outBuffer, charcount_t outBufferSize, char widthForPaddingZerosInsteadSpaces)
    {
        // inlined here
        WORD digit;
