...
namespace Js
{
    ...
    public:
        ...
        Js::RecyclableObject* CreateRegex_TTD(const wchar_t* patternSource, UnifiedRegex::RegexFlags flags, CharCount lastIndex);
        ...
        Js::JavascriptPromiseCapability* CreatePromiseCapability_TTD(Var promise, RecyclableObject* resolve, RecyclableObject* reject);
