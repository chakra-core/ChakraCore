...
#define INIT_ERROR_PROTOTYPE(error) \
    ...
    void JavascriptLibrary::InitializeSIMDObject(DynamicObject* simdObject, DeferredTypeHandlerBase * typeHandler, DeferredInitializeMode mode)
    {
        ...
        builtinFuncs[BuiltinFunction::SIMD_Float32x4_LessThanOrEqual]   = library->AddFunctionToLibraryObject(float32x4Function, PropertyIds::lessThanOrEqual,    &SIMDFloat32x4Lib::EntryInfo::LessThanOrEqual,   3);
        builtinFuncs[BuiltinFunction::SIMD_Float32x4_Equal]             = library->AddFunctionToLibraryObject(float32x4Function, PropertyIds::equal,              &SIMDFloat32x4Lib::EntryInfo::Equal,             3);
        builtinFuncs[BuiltinFunction::SIMD_Float32x4_NotEqual]          =  library->AddFunctionToLibraryObject(float32x4Function, PropertyIds::notEqual,           &SIMDFloat32x4Lib::EntryInfo::NotEqual,          3);
