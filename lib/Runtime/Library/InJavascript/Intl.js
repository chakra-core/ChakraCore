    ...
    var DateTimeFormat = (function () {
        if ((InitType === 'Intl' || InitType === 'Date') && isPlatformUsingICU) {
            ...
            const skeletonSymbolForOption = {
                ...
                hour: { // see note in CLDR - requires further testing
                    h11: {
                        "2-digit": "KK",
                        numeric: "K",
                    },
             ...
             * @param {String} hc the hour cycle 
             */
            const getSkeletonForOptions = function (options, hc) {
            ...
            const InitializeDateTimeFormat = function (dateTimeFormat, locales, options) {
                ...
                const skeleton = getSkeletonForOptions(options, "h12");
