...
(function (EngineInterface, InitType) {
    ...
    if (InitType === "Intl") {
        ...
        const UnicodeExtensionComponents = function (extension) {
            ...
            // langtagToParts doesn't provide that by default because the existing algorithm used
        ...
        const Locale = tagPublicFunction("Intl.Locale", function Locale(tag, options = undefined) {
            ...
            // cache these values for later calls to Locale.prototype.{langauge|script|region|baseName}
