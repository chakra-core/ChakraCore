...
(function (EngineInterface, InitType) {
    ...
    var DateTimeFormat = (function () {
        if ((InitType === 'Intl' || InitType === 'Date') && isPlatformUsingICU) {
             ...
             * @param {String[]} relevantExtensionKeys 
            ...
            const ResolveLocale = function (requestedLocales, options, relevantExtensionKeys, localeData) {
                ...
                _.forEach(relevantExtensionKeys, function (key) {
                    ...
                    // possibly hard-code from https://unicode.org/repos/cldr/trunk/common/bcp47/calendar.xml ?
            ...
            const InitializeDateTimeFormat = function (dateTimeFormat, locales, options) {
                ...
                // the options used to create a pattern has to at least include the fields passed in the given `options` object
                const optionsForPattern = _.reduce(dateTimeComponents, function (resolved, component) {
                ...
                const skeleton = getSkeletonForOptions(optionsForPattern);
                const pattern = platform.getPatternForSkeleton(skeleton);
            ...
            // This code is no longer relevant because we now let ICU do its own format negotiation
            ...
            // const BestFitFormatMatcher = BasicFormatMatcher;
            ...
            const FormatDateTime = function (dtf, x) {
                return platform.formatDateTime(dtf, x);
            };

            const FormatDateTimeToParts = function (dtf, x) {
                return platform.formatDateTimeToParts(dtf, x);
            };
