...
BUILTIN(JavascriptRegistry, NewInstance, NewInstance, FunctionInfo::SkipDefaultNewObject)
BUILTIN(JavascriptRegistry, Delete, EntryDelete, FunctionInfo::ErrorOnNew)
BUILTIN(JavascriptRegistry, Get, EntryGet, FunctionInfo::ErrorOnNew)
...
BUILTIN(JavascriptRegistry, Entries, EntryEntries, FunctionInfo::ErrorOnNew)
...
BUILTIN(JavascriptLoader, NewInstance, NewInstance, FunctionInfo::SkipDefaultNewObject)
BUILTIN(JavascriptLoader, Import, EntryImport, FunctionInfo::ErrorOnNew)
...
BUILTIN(JavascriptModuleStatus, NewInstance, NewInstance, FunctionInfo::SkipDefaultNewObject)
BUILTIN(JavascriptModuleStatus, GetterStage, EntryGetterStage, FunctionInfo::ErrorOnNew)
BUILTIN(JavascriptModuleStatus, GetterOriginalKey, EntryGetterOriginalKey, FunctionInfo::ErrorOnNew)
BUILTIN(JavascriptModuleStatus, GetterModule, EntryGetterModule, FunctionInfo::ErrorOnNew)
BUILTIN(JavascriptModuleStatus, GetterError, EntryGetterError, FunctionInfo::ErrorOnNew)
BUILTIN(JavascriptModuleStatus, GetterDependencies, EntryGetterDependencies, FunctionInfo::SkipDefaultNewObject)
BUILTIN(JavascriptModuleStatus, Load, EntryLoad, FunctionInfo::ErrorOnNew)
...
BUILTIN(JavascriptModuleStatus, ResolveFulfillmentHandler, EntryResolveFulfillmentHandler, FunctionInfo::ErrorOnNew | FunctionInfo::DoNotProfile)
BUILTIN(JavascriptModuleStatus, RejectFulfillmentHandler, EntryRejectFulfillmentHandler, FunctionInfo::ErrorOnNew | FunctionInfo::DoNotProfile)
BUILTIN(JavascriptModuleStatus, ErrorHandler, EntryErrorHandler, FunctionInfo::ErrorOnNew | FunctionInfo::DoNotProfile)
BUILTIN(JavascriptModuleStatus, PostSatisfyInstanceFulfillmentHandler, EntryPostSatisfyInstanceFulfillmentHandler, FunctionInfo::ErrorOnNew | FunctionInfo::DoNotProfile)
BUILTIN(JavascriptModuleStatus, UpgradeToStageFulfillmentHandler, EntryUpgradeToStageFulfillmentHandler, FunctionInfo::ErrorOnNew | FunctionInfo::DoNotProfile)
BUILTIN(JavascriptModuleStatus, RequestTranslateOrInstantiateFulfillmentHandler, EntryRequestTranslateOrInstantiateFulfillmentHandler, FunctionInfo::ErrorOnNew | FunctionInfo::DoNotProfile)
BUILTIN(JavascriptModuleStatus, PostSatisfyInstanceSimpleFulfillmentHandler, EntryPostSatisfyInstanceSimpleFulfillmentHandler, FunctionInfo::ErrorOnNew | FunctionInfo::DoNotProfile)
BUILTIN(JavascriptModuleStatus, SatisfyInstanceWrapperFulfillmentHandler, EntrySatisfyInstanceWrapperFulfillmentHandler, FunctionInfo::ErrorOnNew | FunctionInfo::DoNotProfile)
