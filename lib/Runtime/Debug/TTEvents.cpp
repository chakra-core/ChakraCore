...
namespace TTD
{
    namespace NSLogEvents
    {
        ...
        void TTDInnerLoopLogWriteEventLogEntry_Emit(const EventLogEntry* evt, FileWriter* writer, ThreadContext* threadContext)
        {
            ...
            writer->WriteInt64(NSTokens::Key::eventTime, ilevt->ETime, NSTokens::Separator::CommaSeparator);
            writer->WriteInt64(NSTokens::Key::functionTime, ilevt->FTime, NSTokens::Separator::CommaSeparator);
            writer->WriteInt64(NSTokens::Key::loopTime, ilevt->LTime, NSTokens::Separator::CommaSeparator);
        ...
        void TTDInnerLoopLogWriteEventLogEntry_Parse(EventLogEntry* evt, ThreadContext* threadContext, FileReader* reader, UnlinkableSlabAllocator& alloc)
        {
            ...
            ilevt->ETime = reader->ReadInt64(NSTokens::Key::eventTime, true);
            ilevt->FTime = reader->ReadInt64(NSTokens::Key::functionTime, true);
            ilevt->LTime = reader->ReadInt64(NSTokens::Key::loopTime, true);
