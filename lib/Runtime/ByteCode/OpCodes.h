...
MACRO_BACKEND_ONLY(     Conv_Prim_Check,    Reg2,           OpSideEffect|OpTempNumberSources)  // Convert between primitives (int32/float64); can throw an exception
...
MACRO_BACKEND_ONLY(     OverflowCheck,      Reg2,           OpSideEffect)
