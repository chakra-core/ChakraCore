...
// Function Calls
  ...
  DEF2_WMS( I1toF1Mem        , Reinterpret_ITF, NumberUtilities::ReinterpretBits32                 ) // reinterpret bits of int to float
  DEF2_WMS( F1toI1Mem        , Reinterpret_FTI, NumberUtilities::ToSpecial32                       ) // reinterpret bits of float to int
