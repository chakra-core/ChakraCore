...
namespace Js
{
    ...
    template bool SIMDBool32x4Operation::OpAllTrue<short>(const SIMDValue& val);
    template bool SIMDBool32x4Operation::OpAllTrue<char>(const SIMDValue& val);
    //
    template bool SIMDBool32x4Operation::OpAnyTrue<int>(const SIMDValue& val);
    template bool SIMDBool32x4Operation::OpAnyTrue<short>(const SIMDValue& val);
    template bool SIMDBool32x4Operation::OpAnyTrue<char>(const SIMDValue& val);
}
#endif
