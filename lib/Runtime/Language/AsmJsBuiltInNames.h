...
ASMJS_SIMD_O_NAMES(int32x4_and,                               and,                          Int32x4,          And               )
ASMJS_SIMD_O_NAMES(int32x4_or,                                or,                           Int32x4,          Or                )
ASMJS_SIMD_O_NAMES(int32x4_xor,                               xor,                          Int32x4,          Xor               )
ASMJS_SIMD_O_NAMES(int32x4_not,                               not,                          Int32x4,          Not               )
ASMJS_SIMD_O_NAMES(int32x4_min,                               min,                          Int32x4,          Min               )
ASMJS_SIMD_O_NAMES(int32x4_max,                               max,                          Int32x4,          Max               )
...
ASMJS_SIMD_O_NAMES(bool32x4_not,                              not,                          Bool32x4,         Not     )
...
ASMJS_SIMD_O_NAMES(bool16x8_not,                              not,                          Bool16x8,         Not     )
...
ASMJS_SIMD_O_NAMES(bool8x16_not,                              not,                          Bool8x16,         Not     )
...
ASMJS_SIMD_O_NAMES(float32x4_and,                             and,                          Float32x4,        And                         )
ASMJS_SIMD_O_NAMES(float32x4_or,                              or,                           Float32x4,        Or                          )
ASMJS_SIMD_O_NAMES(float32x4_xor,                             xor,                          Float32x4,        Xor                         )
ASMJS_SIMD_O_NAMES(float32x4_not,                             not,                          Float32x4,        Not                         )
// keep load/store contiguous
...
ASMJS_SIMD_O_NAMES(int16x8_and               ,and                ,                        Int16x8             ,And               )
ASMJS_SIMD_O_NAMES(int16x8_or                ,or                 ,                        Int16x8             ,Or                )
ASMJS_SIMD_O_NAMES(int16x8_xor               ,xor                ,                        Int16x8             ,Xor               )
ASMJS_SIMD_O_NAMES(int16x8_not               ,not                ,                        Int16x8             ,Not               )
...
ASMJS_SIMD_O_NAMES(int16x8_min               ,min                ,                        Int16x8             ,Min               )
ASMJS_SIMD_O_NAMES(int16x8_max               ,max                ,                        Int16x8             ,Max               )
...
ASMJS_SIMD_O_NAMES(int8x16_and               ,and                ,                        Int8x16             ,And               )
ASMJS_SIMD_O_NAMES(int8x16_or                ,or                 ,                        Int8x16             ,Or                )
ASMJS_SIMD_O_NAMES(int8x16_xor               ,xor                ,                        Int8x16             ,Xor               )
ASMJS_SIMD_O_NAMES(int8x16_not               ,not                ,                        Int8x16             ,Not               )
...
ASMJS_SIMD_O_NAMES(int8x16_min               ,min                ,                        Int8x16             ,Min               )
ASMJS_SIMD_O_NAMES(int8x16_max               ,max                ,                        Int8x16             ,Max               )
...
ASMJS_SIMD_O_NAMES(uint32x4_and               , and                  ,                    Uint32x4            ,And               )
ASMJS_SIMD_O_NAMES(uint32x4_or                , or                   ,                    Uint32x4            ,Or                )
ASMJS_SIMD_O_NAMES(uint32x4_xor               , xor                  ,                    Uint32x4            ,Xor               )
ASMJS_SIMD_O_NAMES(uint32x4_not               , not                  ,                    Uint32x4            ,Not               )
...
ASMJS_SIMD_O_NAMES(uint32x4_min               , min                  ,                    Uint32x4            ,Min               )
ASMJS_SIMD_O_NAMES(uint32x4_max               , max                  ,                    Uint32x4            ,Max               )
...
ASMJS_SIMD_O_NAMES(uint16x8_and                   , and                  ,                  Uint16x8           ,And               )
ASMJS_SIMD_O_NAMES(uint16x8_or                    , or                   ,                  Uint16x8           ,Or                )
ASMJS_SIMD_O_NAMES(uint16x8_xor                   , xor                  ,                  Uint16x8           ,Xor               )
ASMJS_SIMD_O_NAMES(uint16x8_not                   , not                  ,                  Uint16x8           ,Not               )
...
ASMJS_SIMD_O_NAMES(uint16x8_min                   , min                  ,                  Uint16x8           ,Min               )
ASMJS_SIMD_O_NAMES(uint16x8_max                   , max                  ,                  Uint16x8           ,Max               )
...
ASMJS_SIMD_O_NAMES(uint8x16_and                  , and                   ,                  Uint8x16           , And               )
ASMJS_SIMD_O_NAMES(uint8x16_or                   , or                    ,                  Uint8x16           , Or                )
ASMJS_SIMD_O_NAMES(uint8x16_xor                  , xor                   ,                  Uint8x16           , Xor               )
ASMJS_SIMD_O_NAMES(uint8x16_not                  , not                   ,                  Uint8x16           , Not               )
...
ASMJS_SIMD_O_NAMES(uint8x16_min                  , min                   ,                  Uint8x16           , Min               )
ASMJS_SIMD_O_NAMES(uint8x16_max                  , max                   ,                  Uint8x16           , Max               )
