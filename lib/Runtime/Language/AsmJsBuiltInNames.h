...
ASMJS_SIMD_O_NAMES(float32x4_and,                             and_,                         Float32x4,        And                         )
ASMJS_SIMD_O_NAMES(float32x4_or,                              or_,                          Float32x4,        Or                          )
ASMJS_SIMD_O_NAMES(float32x4_xor,                             xor_,                         Float32x4,        Xor                         )
ASMJS_SIMD_O_NAMES(float32x4_not,                             not_,                         Float32x4,        Not                         )
// keep load/store contiguous
