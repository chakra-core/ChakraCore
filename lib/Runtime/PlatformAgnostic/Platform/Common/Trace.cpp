...
// Required compiler args are -finstrument-functions, -fno-pic
// -finstrument-functions enables GCC/Clang to inject __cyg_profile_func_enter/exit
// -fno-pic is required to resolve function names later (on OSX, you should also set -fno-PIE)
...
// TODO
// - Create a script tooling that converts function address to mangled names (osx - atos / linux - addr2line / or objdump ?)
// - Develop a basic web / console based UI ?
