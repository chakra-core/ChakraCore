...
namespace Js
{
    ...
    */
    ...
    To support snapshot enumetation we need to remember the type handler at the start of the enumeration in case the type evolves during enumeration. To achieve this we lock BOTH the
