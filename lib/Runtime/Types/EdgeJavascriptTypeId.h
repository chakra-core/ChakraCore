...
enum TypeId
{
    ...
    TypeIds_AsyncFromSyncIterator = 71,
    TypeIds_Promise = 72,
    TypeIds_SharedArrayBuffer = 73,

    TypeIds_WebAssemblyModule = 74,
    TypeIds_WebAssemblyInstance = 75,
    TypeIds_WebAssemblyMemory = 76,
    TypeIds_WebAssemblyTable = 77,

    TypeIds_LastBuiltinDynamicObject = TypeIds_WebAssemblyTable,
    TypeIds_GlobalObject = 78,
    TypeIds_ModuleRoot = 79,
    TypeIds_LastTrueJavascriptObjectType = TypeIds_ModuleRoot,

    TypeIds_HostObject = 80,
    TypeIds_ActivationObject = 81,
    TypeIds_SpreadArgument = 82,
    TypeIds_ModuleNamespace = 83,
    TypeIds_ListIterator = 84,
    TypeIds_ExternalIterator = 85,
