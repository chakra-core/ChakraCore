...
ENTRY_SYMBOL(_symbolMatch, L"Symbol.match")
ENTRY_SYMBOL(_symbolReplace, L"Symbol.replace")
ENTRY_SYMBOL(_symbolSearch, L"Symbol.search")
ENTRY_SYMBOL(_symbolSplit, L"Symbol.split")
...
ENTRY2(_RuntimeFunctionNameId_replace, L"[Symbol.replace]")
ENTRY2(_RuntimeFunctionNameId_search, L"[Symbol.search]")
ENTRY2(_RuntimeFunctionNameId_match, L"[Symbol.match]")
ENTRY2(_RuntimeFunctionNameId_split, L"[Symbol.split]")
