...
ThreadContext::ThreadContext(AllocationPolicyManager * allocationPolicyManager, JsUtil::ThreadService::ThreadServiceCallback threadServiceCallback, bool enableExperimentalFeatures) :
    ...
    , TTDGeneralAllocator(_u("TTDGeneralAllocator"), &this->pageAllocator, nullptr)
    , TTDBulkAllocator(_u("TTDBulkAllocator"), &this->pageAllocator, nullptr)
    , TTDTaggingAllocator(_u("TTDTaggingAllocator"), &this->pageAllocator, nullptr)
    , TTDContextAllocator(_u("TTDContextAllocator"), &this->pageAllocator, nullptr)
    , TTDLog(nullptr)
    , TTDInfo(nullptr)
