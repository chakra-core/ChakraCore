...
namespace Js
{
    ...
    uint ScriptContext::SaveSourceNoCopy(Utf8SourceInfo* sourceInfo, int cchLength, bool isCesu8)
    {
        ...
        if (this->IsScriptContextInDebugMode() && !sourceInfo->GetIsLibraryCode() && !sourceInfo->IsUtf8SourceInfoInDebugMode())
        {
    ...
    void ScriptContext::TransitionEnvironmentForDebugger(ScriptFunction * scriptFunction)
    {
        if (scriptFunction->GetScriptContext()->IsScriptContextInDebugMode() &&
            scriptFunction->GetFunctionBody()->GetUtf8SourceInfo()->IsUtf8SourceInfoInDebugMode() && 
    ...
    void ScriptContext::RecyclerFunctionCallbackForDebugger(void *address, size_t size)
    {
        ...
        if (scriptContext->IsScriptContextInDebugMode() && !proxy->GetUtf8SourceInfo()->GetIsLibraryCode() && !pBody->GetUtf8SourceInfo()->IsUtf8SourceInfoInDebugMode())
        {
