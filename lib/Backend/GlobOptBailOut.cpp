...
bool
GlobOpt::IsImplicitCallBailOutCurrentlyNeeded(IR::Instr const * instr, Value const * src1Val, Value const * src2Val) const
{
    Assert(!this->IsLoopPrePass());
...
bool
GlobOpt::IsImplicitCallBailOutCurrentlyNeeded(IR::Instr const * instr, Value const * src1Val, Value const * src2Val, BasicBlock const * block, bool hasLiveFields, bool mayNeedImplicitCallBailOut, bool isForwardPass) const
{
