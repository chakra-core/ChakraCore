...
private:
    ...
    void                    CompensateSimd128OnBackEdge(BasicBlock * block, BVSparse<JitArenaAllocator> * loopSimd128SymsOnEntry, BVSparse<JitArenaAllocator> * liveSimd128Syms, BVSparse<JitArenaAllocator> * liveOnBackEdge, IR::BailOutKind bailOutKind, IRType type);
    void                    CompensateSimd128OnLandingPad(BasicBlock * header, BVSparse<JitArenaAllocator> * loopSimd128SymsOnEntry, BVSparse<JitArenaAllocator> * landingPadLiveSimd128Syms, BVSparse<JitArenaAllocator> * headerLiveSimd128Syms, BVSparse<JitArenaAllocator> * liveOnBackEdge, IR::BailOutKind bailOutKind, IRType type);
    void                    SetSimd128MergedValues(BasicBlock * mergedBlock);
    void                    SetSimd128LoopHeaderValues(BasicBlock * loopHeader, SymTable *const symTable, GlobHashTable *const symToValueMap);
