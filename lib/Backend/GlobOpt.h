...
private:
    ...
    void                    MergeCapturedValues(GlobOptBlockData * toData, SListBase<CaptureList>* toList, SListBase<CaptureList> * fromList, CapturedItemsAreEqual itemsAreEqual);
...
private:
    ...
    bool                    DoLdLenIntSpec(IR::Instr const * const instr, const ValueType baseValueType) const;
...
private:
    ...
    bool                    IsImplicitCallBailOutCurrentlyNeeded(IR::Instr const * instr, Value const * src1Val, Value const * src2Val) const;
    bool                    IsImplicitCallBailOutCurrentlyNeeded(IR::Instr const * instr, Value const * src1Val, Value const * src2Val, BasicBlock const * block, bool hasLiveFields, bool mayNeedImplicitCallBailOut, bool isForwardPass) const;
