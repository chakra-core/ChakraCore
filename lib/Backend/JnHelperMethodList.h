...
HELPERCALL(DirectMath_Int64DivS, Wasm::WasmMath::Div<int64>, 0)
HELPERCALL(DirectMath_Int64DivU, Wasm::WasmMath::Div<uint64>, 0)
HELPERCALL(DirectMath_Int64RemS, Wasm::WasmMath::Rem<int64>, 0)
HELPERCALL(DirectMath_Int64RemU, Wasm::WasmMath::Rem<uint64>, 0)
HELPERCALL(DirectMath_Int64Shl, Wasm::WasmMath::Shl<int64>, 0)
HELPERCALL(DirectMath_Int64Shr, Wasm::WasmMath::Shr<int64>, 0)
HELPERCALL(DirectMath_Int64ShrU, Wasm::WasmMath::ShrU<uint64>, 0)
HELPERCALL(DirectMath_Int64Rol, Wasm::WasmMath::Rol<int64>, 0)
HELPERCALL(DirectMath_Int64Ror, Wasm::WasmMath::Ror<int64>, 0)
HELPERCALL(DirectMath_Int64Clz, Wasm::WasmMath::Clz<int64>, 0)
HELPERCALL(DirectMath_Int64Ctz, Wasm::WasmMath::Ctz<int64>, 0)
#elif defined(_M_X64)
