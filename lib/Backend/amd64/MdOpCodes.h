...
MACRO(PMOVMSKB, Reg2,   None,           RNON,   f(MODRM),   o(PMOVMSKB),DNO16|DOPEQ|D66,            OLB_0F)
...
MACRO(PSLLD,    Reg2,   None,           R110,   f(SPECIAL), o(PSLLD),   DDST|DNO16|DOPEQ|D66|DSSE,  OLB_0F)
...
MACRO(PSLLW,    Reg2,   None,           R110,   f(SPECIAL), o(PSLLW),   DDST|DNO16|DOPEQ|D66|DSSE,  OLB_0F)
MACRO(PSRAD,    Reg2,   None,           R100,   f(SPECIAL), o(PSRAD),   DDST|DNO16|DOPEQ|D66|DSSE,  OLB_0F)
MACRO(PSRAW,    Reg2,   None,           R100,   f(SPECIAL), o(PSRAW),   DDST|DNO16|DOPEQ|D66|DSSE,  OLB_0F)
MACRO(PSRLD,    Reg2,   None,           R010,   f(SPECIAL), o(PSRLD),   DDST|DNO16|DOPEQ|D66|DSSE,  OLB_0F)
MACRO(PSRLDQ,   Reg2,   None,           R011,   f(SPECIAL), o(PSRLDQ),  DDST|DNO16|DOPEQ|D66|DSSE,  OLB_0F)
MACRO(PSRLW,    Reg2,   None,           R010,   f(SPECIAL), o(PSRLW),   DDST|DNO16|DOPEQ|D66|DSSE,  OLB_0F)
