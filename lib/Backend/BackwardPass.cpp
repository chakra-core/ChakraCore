...
StackSym*
BackwardPass::ProcessByteCodeUsesDst(IR::Instr * instr)
{
...
BackwardPass::ProcessByteCodeUsesSrcs(IR::Instr * instr)
{
...
BackwardPass::ProcessByteCodeUsesInstr(IR::Instr * instr)
{
    ...
    if (this->tag == Js::BackwardPhase)
    {
        ...
        const BVSparse<JitArenaAllocator>* byteCodeUpwardExposedUsed = ProcessByteCodeUsesSrcs(instr);
    ...
    else
    {
        ...
        if (this->func->hasBailout)
        {
            ...
            StackSym *dstStackSym = ProcessByteCodeUsesDst(instr);
#if DBG
            ...
            PropertySym *propertySymUse = instr->AsByteCodeUsesInstr()->propertySymUse;
