...
WASM_CTRL_OPCODE(IfThen,         0x04,       IF,                 Limit)
WASM_CTRL_OPCODE(Select,         0x05,       LIMIT,              Limit)
WASM_CTRL_OPCODE(Br,             0x06,       LIMIT,              Limit)
...
WASM_MISC_OPCODE(I8Const,        0x09,        LIMIT,             Limit)
...
WASM_SIMPLE_OPCODE(I32ShrS,             0x4c, SHR_I32,          I_II)
...
WASM_SIMPLE_OPCODE(I32Clz,              0x57, CLZ,               I_I)
WASM_SIMPLE_OPCODE(I32Ctz,              0x58, CTZ,               I_I)
