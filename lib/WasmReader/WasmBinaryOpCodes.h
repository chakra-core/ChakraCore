...
WASM_MISC_OPCODE(I64Const,     0x42, Limit, true)
...
WASM_MEMREAD_OPCODE(I32LoadMem8S,  0x2c, I_I, false)
WASM_MEMREAD_OPCODE(I32LoadMem8U,  0x2d, I_I, false)
WASM_MEMREAD_OPCODE(I32LoadMem16S, 0x2e, I_I, false)
WASM_MEMREAD_OPCODE(I32LoadMem16U, 0x2f, I_I, false)
WASM_MEMREAD_OPCODE(I64LoadMem8S,  0x30, L_I, true)
WASM_MEMREAD_OPCODE(I64LoadMem8U,  0x31, L_I, true)
WASM_MEMREAD_OPCODE(I64LoadMem16S, 0x32, L_I, true)
WASM_MEMREAD_OPCODE(I64LoadMem16U, 0x33, L_I, true)
WASM_MEMREAD_OPCODE(I64LoadMem32S, 0x34, L_I, true)
WASM_MEMREAD_OPCODE(I64LoadMem32U, 0x35, L_I, true)
WASM_MEMREAD_OPCODE(I32LoadMem,    0x28, I_I, false)
WASM_MEMREAD_OPCODE(I64LoadMem,    0x29, L_I, true)
WASM_MEMREAD_OPCODE(F32LoadMem,    0x2a, F_I, false)
WASM_MEMREAD_OPCODE(F64LoadMem,    0x2b, D_I, false)

// Store memory expressions.
WASM_MEMSTORE_OPCODE(I32StoreMem8,  0x3a, I_II, false)
WASM_MEMSTORE_OPCODE(I32StoreMem16, 0x3b, I_II, false)
WASM_MEMSTORE_OPCODE(I64StoreMem8,  0x3c, L_IL, true)
WASM_MEMSTORE_OPCODE(I64StoreMem16, 0x3d, L_IL, true)
WASM_MEMSTORE_OPCODE(I64StoreMem32, 0x3e, L_IL, true)
WASM_MEMSTORE_OPCODE(I32StoreMem,   0x36, I_II, false)
WASM_MEMSTORE_OPCODE(I64StoreMem,   0x37, L_IL, true)
WASM_MEMSTORE_OPCODE(F32StoreMem,   0x38, F_IF, false)
WASM_MEMSTORE_OPCODE(F64StoreMem,   0x39, D_ID, false)

// Memory operator
WASM_MISC_OPCODE(CurrentMemory, 0x3f, I_I, false)
WASM_MISC_OPCODE(GrowMemory,    0x40, I_I, true)
...
WASM_BINARY_OPCODE(I64Add,            0x7c, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64Sub,            0x7d, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64Mul,            0x7e, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64DivS,           0x7f, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64DivU,           0x80, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64RemS,           0x81, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64RemU,           0x82, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64And,            0x83, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64Ior,            0x84, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64Xor,            0x85, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64Shl,            0x86, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64ShrU,           0x88, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64ShrS,           0x87, L_LL, Nop            , true)
WASM_BINARY_OPCODE(I64Eq,             0x51, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64Ne,             0x52, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64LtS,            0x53, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64LeS,            0x57, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64LtU,            0x54, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64LeU,            0x58, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64GtS,            0x55, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64GeS,            0x59, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64GtU,            0x56, I_LL, Nop            , true)
WASM_BINARY_OPCODE(I64GeU,            0x5a, I_LL, Nop            , true)
WASM_UNARY__OPCODE(I64Clz,            0x79, L_L , Nop            , true)
WASM_UNARY__OPCODE(I64Ctz,            0x7a, L_L , Nop            , true)
WASM_UNARY__OPCODE(I64Popcnt,         0x7b, L_L , Nop            , true)
...
WASM_UNARY__OPCODE(I32SConvertF32,    0xa8, I_F , Conv_FTI       , false)
WASM_UNARY__OPCODE(I32SConvertF64,    0xaa, I_D , Conv_DTI       , false)
WASM_UNARY__OPCODE(I32UConvertF32,    0xa9, I_F , Conv_FTU       , true)
WASM_UNARY__OPCODE(I32UConvertF64,    0xab, I_D , Conv_DTU       , true)
WASM_UNARY__OPCODE(I32ConvertI64,     0xa7, I_L , Nop            , true)
WASM_UNARY__OPCODE(I64SConvertF32,    0xae, L_F , Nop            , true)
WASM_UNARY__OPCODE(I64SConvertF64,    0xb0, L_D , Nop            , true)
WASM_UNARY__OPCODE(I64UConvertF32,    0xaf, L_F , Nop            , true)
WASM_UNARY__OPCODE(I64UConvertF64,    0xb1, L_D , Nop            , true)
WASM_UNARY__OPCODE(I64SConvertI32,    0xac, L_I , Nop            , true)
WASM_UNARY__OPCODE(I64UConvertI32,    0xad, L_I , Nop            , true)
...
WASM_UNARY__OPCODE(F32ConvertF64,     0xb6, F_D , Fround_Db      , false)
...
WASM_UNARY__OPCODE(F64ConvertF32,     0xbb, D_F , Conv_FTD       , false)
