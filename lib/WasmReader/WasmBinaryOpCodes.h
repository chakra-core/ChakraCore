...
WASM_PREFIX(Tracing, WASM_PREFIX_TRACING, true, "")
#endif
...
WASM_ATOMICREAD_OPCODE (I32AtomicLoad          , __prefix | 0x10, I_I  , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT32, "i32.atomic.load")
WASM_ATOMICREAD_OPCODE (I64AtomicLoad          , __prefix | 0x11, L_I  , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT64, "i64.atomic.load")
WASM_ATOMICREAD_OPCODE (I32AtomicLoad8U        , __prefix | 0x12, I_I  , (false && __has_atomics), Js::ArrayBufferView::TYPE_UINT8, "i32.atomic.load8_u")
WASM_ATOMICREAD_OPCODE (I32AtomicLoad16U       , __prefix | 0x13, I_I  , (false && __has_atomics), Js::ArrayBufferView::TYPE_UINT16, "i32.atomic.load16_u")
WASM_ATOMICREAD_OPCODE (I64AtomicLoad8U        , __prefix | 0x14, L_I  , (false && __has_atomics), Js::ArrayBufferView::TYPE_UINT8_TO_INT64, "i64.atomic.load8_u")
WASM_ATOMICREAD_OPCODE (I64AtomicLoad16U       , __prefix | 0x15, L_I  , (false && __has_atomics), Js::ArrayBufferView::TYPE_UINT16_TO_INT64, "i64.atomic.load16_u")
WASM_ATOMICREAD_OPCODE (I64AtomicLoad32U       , __prefix | 0x16, L_I  , (false && __has_atomics), Js::ArrayBufferView::TYPE_UINT32_TO_INT64, "i64.atomic.load32_u")
WASM_ATOMICSTORE_OPCODE(I32AtomicStore         , __prefix | 0x17, I_II , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT32, "i32.atomic.store")
WASM_ATOMICSTORE_OPCODE(I64AtomicStore         , __prefix | 0x18, L_IL , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT64, "i64.atomic.store")
WASM_ATOMICSTORE_OPCODE(I32AtomicStore8        , __prefix | 0x19, I_II , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT8, "i32.atomic.store8")
WASM_ATOMICSTORE_OPCODE(I32AtomicStore16       , __prefix | 0x1a, I_II , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT16, "i32.atomic.store16")
WASM_ATOMICSTORE_OPCODE(I64AtomicStore8        , __prefix | 0x1b, L_IL , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT8_TO_INT64, "i64.atomic.store8")
WASM_ATOMICSTORE_OPCODE(I64AtomicStore16       , __prefix | 0x1c, L_IL , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT16_TO_INT64, "i64.atomic.store16")
WASM_ATOMICSTORE_OPCODE(I64AtomicStore32       , __prefix | 0x1d, L_IL , (false && __has_atomics), Js::ArrayBufferView::TYPE_INT32_TO_INT64, "i64.atomic.store32")
