...
////////////////////////////////////////////////////////////
// Conversions
WASM_UNARY__OPCODE(I32Wrap_I64,       0xa7, I_L , Nop            , true)
WASM_UNARY__OPCODE(I32TruncS_F32,     0xa8, I_F , Conv_FTI       , false)
WASM_UNARY__OPCODE(I32TruncU_F32,     0xa9, I_F , Conv_FTU       , true)
WASM_UNARY__OPCODE(I32TruncS_F64,     0xaa, I_D , Conv_DTI       , false)
WASM_UNARY__OPCODE(I32TruncU_F64,     0xab, I_D , Conv_DTU       , true)

WASM_UNARY__OPCODE(I64ExtendS_I32,    0xac, L_I , Nop            , true)
WASM_UNARY__OPCODE(I64ExtendU_I32,    0xad, L_I , Nop            , true)
WASM_UNARY__OPCODE(I64TruncS_F32,     0xae, L_F , Nop            , true)
WASM_UNARY__OPCODE(I64TruncU_F32,     0xaf, L_F , Nop            , true)
WASM_UNARY__OPCODE(I64TruncS_F64,     0xb0, L_D , Nop            , true)
WASM_UNARY__OPCODE(I64TruncU_F64,     0xb1, L_D , Nop            , true)
