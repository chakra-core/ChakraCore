...
WASM_BINARY_OPCODE(I32ShrU,           0x4b, I_II, ShrU_Int       , false)
...
WASM_BINARY_OPCODE(I32LtU,            0x51, I_II, CmLt_UnInt     , false)
WASM_BINARY_OPCODE(I32LeU,            0x52, I_II, CmLe_UnInt     , false)
WASM_BINARY_OPCODE(I32GtS,            0x53, I_II, CmGt_Int       , false)
WASM_BINARY_OPCODE(I32GeS,            0x54, I_II, CmGe_Int       , false)
WASM_BINARY_OPCODE(I32GtU,            0x55, I_II, CmGt_UnInt     , false)
WASM_BINARY_OPCODE(I32GeU,            0x56, I_II, CmGe_UnInt     , false)
