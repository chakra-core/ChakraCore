...
(assert_return_nan (invoke "f32.abs" (f32.const nan)))
(assert_return_nan (invoke "f32.abs" (f32.const -nan)))
(assert_return_nan (invoke "f32.abs" (f32.const nan:0x0f1e2)))
(assert_return_nan (invoke "f32.abs" (f32.const -nan:0x0f1e2)))
(assert_return_nan (invoke "f64.abs" (f64.const nan)))
(assert_return_nan (invoke "f64.abs" (f64.const -nan)))
(assert_return_nan (invoke "f64.abs" (f64.const nan:0x0f1e27a6b)))
(assert_return_nan (invoke "f64.abs" (f64.const -nan:0x0f1e27a6b)))

(assert_return_nan (invoke "f32.neg" (f32.const nan)))
(assert_return_nan (invoke "f32.neg" (f32.const -nan)))
(assert_return_nan (invoke "f32.neg" (f32.const nan:0x0f1e2)))
(assert_return_nan (invoke "f32.neg" (f32.const -nan:0x0f1e2)))
(assert_return_nan (invoke "f64.neg" (f64.const nan)))
(assert_return_nan (invoke "f64.neg" (f64.const -nan)))
(assert_return_nan (invoke "f64.neg" (f64.const nan:0x0f1e27a6b)))
(assert_return_nan (invoke "f64.neg" (f64.const -nan:0x0f1e27a6b)))

(assert_return_nan (invoke "f32.copysign" (f32.const nan) (f32.const nan)))
(assert_return_nan (invoke "f32.copysign" (f32.const nan) (f32.const -nan)))
(assert_return_nan (invoke "f32.copysign" (f32.const -nan) (f32.const nan)))
(assert_return_nan (invoke "f32.copysign" (f32.const -nan) (f32.const -nan)))
(assert_return_nan (invoke "f32.copysign" (f32.const nan:0x0f1e2) (f32.const nan)))
(assert_return_nan (invoke "f32.copysign" (f32.const nan:0x0f1e2) (f32.const -nan)))
(assert_return_nan (invoke "f32.copysign" (f32.const -nan:0x0f1e2) (f32.const nan)))
(assert_return_nan (invoke "f32.copysign" (f32.const -nan:0x0f1e2) (f32.const -nan)))
(assert_return_nan (invoke "f64.copysign" (f64.const nan) (f64.const nan)))
(assert_return_nan (invoke "f64.copysign" (f64.const nan) (f64.const -nan)))
(assert_return_nan (invoke "f64.copysign" (f64.const -nan) (f64.const nan)))
(assert_return_nan (invoke "f64.copysign" (f64.const -nan) (f64.const -nan)))
(assert_return_nan (invoke "f64.copysign" (f64.const nan:0x0f1e27a6b) (f64.const nan)))
(assert_return_nan (invoke "f64.copysign" (f64.const nan:0x0f1e27a6b) (f64.const -nan)))
(assert_return_nan (invoke "f64.copysign" (f64.const -nan:0x0f1e27a6b) (f64.const nan)))
(assert_return_nan (invoke "f64.copysign" (f64.const -nan:0x0f1e27a6b) (f64.const -nan)))
...
(assert_return_nan (invoke "f32.min" (f32.const 0.0) (f32.const nan:0x200000)))
(assert_return_nan (invoke "f32.min" (f32.const nan:0x200000) (f32.const 0.0)))
(assert_return_nan (invoke "f32.max" (f32.const 0.0) (f32.const nan:0x200000)))
(assert_return_nan (invoke "f32.max" (f32.const nan:0x200000) (f32.const 0.0)))
(assert_return_nan (invoke "f64.min" (f64.const 0.0) (f64.const nan:0x4000000000000)))
(assert_return_nan (invoke "f64.min" (f64.const nan:0x4000000000000) (f64.const 0.0)))
(assert_return_nan (invoke "f64.max" (f64.const 0.0) (f64.const nan:0x4000000000000)))
(assert_return_nan (invoke "f64.max" (f64.const nan:0x4000000000000) (f64.const 0.0)))
