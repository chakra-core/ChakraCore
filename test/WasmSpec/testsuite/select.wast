...
(assert_return_nan (invoke "select_f32" (f32.const nan:0x20304) (f32.const 1) (i32.const 1)))
...
(assert_return_nan (invoke "select_f32" (f32.const 2) (f32.const nan:0x20304) (i32.const 0)))
