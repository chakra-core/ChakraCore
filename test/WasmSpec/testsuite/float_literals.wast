...
;;(assert_return_nan (invoke "f32.informally_known_as_plain_snan"))
(assert_return (invoke "f32.all_ones_nan") (i32.const 0xffffffff))
;;(assert_return_nan (invoke "f32.misc_nan"))
;;(assert_return_nan (invoke "f32.misc_positive_nan"))
;;(assert_return_nan (invoke "f32.misc_negative_nan"))
