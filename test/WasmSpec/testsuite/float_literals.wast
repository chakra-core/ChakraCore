...
;;(assert_return (invoke "f64.informally_known_as_plain_snan") (i64.const 0x7ff4000000000000)) Fails for x86
(assert_return (invoke "f64.all_ones_nan") (i64.const 0xffffffffffffffff))
;;(assert_return (invoke "f64.misc_nan") (i64.const 0x7ff0123456789abc)) Fails for x86
;;(assert_return (invoke "f64.misc_positive_nan") (i64.const 0x7ff3040506070809)) Fails for x86
;;(assert_return (invoke "f64.misc_negative_nan") (i64.const 0xfff2abcdef012345)) Fails for x86
