    ...
    },
    {
        ...
        body: function ()
        {
            function test(x, y, z) {
                var a = [x], b = [y, z], c = [y, z];
                areEqual([x, y, z], a.concat(b), '[@@isConcatSpreadable] undefined');
                areEqual([x, y, z], a.concat(c), '[@@isConcatSpreadable] undefined');
                ...
                areEqual([x, [y, z]], a.concat(b), '[@@isConcatSpreadable]==false');
                areEqual([x, [y, z]], a.concat(c), '[@@isConcatSpreadable]==false');
                ...
                areEqual([x, y, z], a.concat(b), '[@@isConcatSpreadable]==true');
                areEqual([x, y, z], a.concat(c), '[@@isConcatSpreadable]==true');
                ...
                areEqual([x, y, z], a.concat(b), '[@@isConcatSpreadable] deleted');
                areEqual([x, y, z], a.concat(c), '[@@isConcatSpreadable] deleted');
            }
    ...
    },
    {
        ...
        body: function ()
        {
            function test(arr, idx, elem) {
                ...
                areEqual(expected, Array.prototype.concat.call(arr), 'expecting ['+expected+']');
            }
