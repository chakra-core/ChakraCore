  ...
  },
  {
    ...
    },
    {
        ...
        body: function () {
            ...
            var C = class C { set x(a){ this._x = a; } set y(a){ this._y = a; }};
            var D = class D { constructor() {}  get x() { return 0; } };
            var E = D;
            ...
            assert.areEqual("class C { set x(a){ this._x = a; } set y(a){ this._y = a; }}", C.prototype.constructor.toString());
